...
namespace SceneEditor.Tools
{
    public class EexBinaryWriter
    {
        ...
        public EexBinaryWriter() : this(ENCODING_GBK)
        {
        }

        public EexBinaryWriter(String encodingName)
        {
        ...
        public EexBinaryWriter setIndex(int i)
        {
            reAlloc(i + 1);
            index = i;
            return this;
        ...
        private void writeBytes(byte[] result)
        {
