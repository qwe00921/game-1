...
namespace TRGameCheck.Command.Scene
{
    public class EexBinaryReader
    {
        ...
        public string readFixString(int length)
        {
            ...
            {
                throw new IndexOutOfRangeException(String.Format("readUShort,index={0},length={1},content={2}", index, length, content.Length));
            }
                ...
                case EexType.EexBoolean:
                    {
                        ...
                        throw new ApplicationException("readFieldBoolean,boolValue=" + readInt.ToString());
                    }
        ...
        public Object readFieldObject(int fieldId)
        {
            ...
            if (readId != fieldId)
            {
                throw new ApplicationException(String.Format("readFieldObject,fieldId=0x{0:x2},readId=0x{1:x2}", fieldId, readId));
            }
