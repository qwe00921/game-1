...
namespace TRGameRepack.Repack
{
    class AndroidApp : BaseApp
    {
        ...
        private void unpackApk(string fileName, string outDir)
        {
            ...
            pro.StandardInput.WriteLine(String.Format(@"apktool d ..\{0}\{1} ..\{0}\{2}", OutputDirName, fileName, outDir));
        ...
        public void packApk(string channelId, string packageName, string versionName)
        {
            ...
            {
                pro.StandardInput.WriteLine(String.Format(@"apktool b ..\{0}\{1} ..\{0}\unsigned.apk", OutputDirName, Path.GetFileNameWithoutExtension(FileBackupName)));
                pro.StandardInput.WriteLine("exit");
                pro.WaitForExit();
                pro.Close();
