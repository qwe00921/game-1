...
namespace TRGameRepack.Repack
{
    public abstract class BaseApp
    {
        ...
        {
            string destDir = getAssetPath(readGameDirName());
        ...
        {
            return readJsonFile(getAssetPath("function.txt"));
        }
        ...
        public void editFunctionTxt(string channelId, bool encryptRes, string packageName)
        {
            ...
            using (StreamWriter tw = new StreamWriter(getAssetPath("function.txt"), false, Encoding.UTF8))
            {
